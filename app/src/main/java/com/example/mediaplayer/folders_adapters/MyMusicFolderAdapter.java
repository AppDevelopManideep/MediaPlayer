...
public class MyMusicFolderAdapter extends BaseAdapter {
    ...
    public MyMusicFolderAdapter(Context context, ArrayList<String> folderPath, ArrayList<MediaFiles> mediaFiles) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(context, MusicFiles.class);
